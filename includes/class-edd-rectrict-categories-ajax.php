...
class EDD_Restrict_Categories_Ajax {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_eddrc_search_users', array( $this, 'search_users' ) );

		// Ajax callback for adding a new user to the whitelist
		add_action( 'wp_ajax_eddrc_add_user', array( $this, 'add_user' ) );
	}

	/**
	 * Ajax callback for searching users by keyword
	 *
	 * @action wp_ajax_eddrc_search_users
	 *
	 * @access public
	 * @since 1.0.0
	 *
...
new EDD_Restrict_Categories_Ajax();
